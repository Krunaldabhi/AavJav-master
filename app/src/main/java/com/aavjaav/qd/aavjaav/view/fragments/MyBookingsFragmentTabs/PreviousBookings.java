...
public class PreviousBookings extends Fragment implements BookingsContract.BookingsView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_previous_booking, container, false);
        ...
        previousBookings = SingletonStorage.getInstance().getPreviousBookings();
        mAdapter = new BookingsAdapter(getContext(), previousBookings);
    ...
    public static PreviousBookings newInstance() {
        Bundle args = new Bundle();

        PreviousBookings fragment = new PreviousBookings();
